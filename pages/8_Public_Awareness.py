...
def show_awareness_page():
    ...
    tab_travel, tab_digital, tab_work = st.tabs(["🚶‍♀️ Travel & Public Spaces", "💻 Cyber & Digital Safety", "🏢 Workplace Safety"])
    ...
    with col_rights:
        st.markdown("### ⚖️ Know Your Legal Rights")
        st.markdown("""
    ...
    with col_gov:
        st.markdown("### 🏛️ Government Initiatives")
        st.markdown("""
